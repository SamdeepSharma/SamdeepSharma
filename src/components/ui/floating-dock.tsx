...
const FloatingDockMobile = ({
  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      >
        {open ? <IconLayoutNavbarExpand className="h-5 w-5 text-neutral-500 dark:text-neutral-400" /> : <IconLayoutNavbarCollapse className="h-5 w-5 text-neutral-500 dark:text-neutral-400" />}
      </button>
    </div>
  );
};
